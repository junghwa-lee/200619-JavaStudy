...
public class JoinForm extends JPanel {
	...
	public JoinForm()
	{
		back=Toolkit.getDefaultToolkit().getImage("c:\\javaDev\\back.jpg"); //이미지갖고오기
		...
		title.setFont(new Font("궁서체",Font.BOLD,45));
		...
		add(la10);add(js);
		//레시피
		box1=new JCheckBox("면");
		box2=new JCheckBox("밥");
		box3=new JCheckBox("양식");
		box4=new JCheckBox("디저트");
		box5=new JCheckBox("음료");
