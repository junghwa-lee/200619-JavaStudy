...
public class 자바출력메소드 {
	...
	public static void main(String[] args) {
		...
		// 2,8,16진법 표현
		System.out.println(Integer.toBinaryString(240)); //이진법  11110000
		System.out.println(Integer.toHexString(240));  //16진법   f0
		System.out.println(Integer.toOctalString(240)); //8진법   360
		
		System.out.println(0xf0);
		System.out.println(0360);
		System.out.println(0b11110000); //
		System.out.println(~100); // ==> -101   .. 음수는 1이 더 많음
